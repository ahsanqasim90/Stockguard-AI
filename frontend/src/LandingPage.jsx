...
export default function LandingPage() {
  ...
  return <div className="landing" id="top">
    ...
    <main>
      ...
      <section className="architecture-section"><div className="section-intro"><span>Proposal-aligned platform</span><h2>A clear, scalable <em>system architecture</em></h2></div><div className="architecture-grid"><article><div><Users /></div><span>Client layer</span><h3>React + React Native</h3><p>Responsive web dashboard and Expo mobile application on one authenticated API.</p></article><ChevronRight /><article><div><Layers3 /></div><span>Business layer</span><h3>Node.js + Express</h3><p>Authentication, product management, sales uploads and application APIs.</p></article><ChevronRight /><article><div><Database /></div><span>Data layer</span><h3>MongoDB</h3><p>Users, products, sales, inventory, forecasts and recommendations.</p></article><ChevronRight /><article><div><BrainCircuit /></div><span>Intelligence layer</span><h3>XGBoost runtime</h3><p>Verified tree inference, recursive feature processing and seasonal fallback.</p></article></div></section>
