...
const forecastRunSchema = new mongoose.Schema({
  ...
  inventoryPlan: {
    ...
    serviceLevelFactor: { type: Number, min: 0, default: 1.65 },
    historicalAverageDailyDemand: { type: Number, min: 0, default: 0 },
    demandStdDev: { type: Number, min: 0, default: 0 },
    averageDailyDemand: { type: Number, min: 0, default: 0 },
    demandChangePercent: { type: Number, default: 0 },
    demandSpike: { type: Boolean, default: false },
    leadTimeDemand: { type: Number, min: 0, default: 0 },
    variabilitySafetyStock: { type: Number, min: 0, default: 0 },
    policySafetyStock: { type: Number, min: 0, default: 0 },
    ...
    daysOfCover: { type: Number, min: 0, default: null },
